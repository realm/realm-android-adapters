...
public class RealmCursor<T extends RealmModel> implements Cursor {
    ...
    @NonNull
    private T getCurrentObject() throws IllegalStateException, IndexOutOfBoundsException {
    ...
    public short getShort(int columnIndex) {
        ...
        switch (columnType) {
            case INTEGER:
                ...
                if (aLong <= Short.MIN_VALUE)
                    return Short.MIN_VALUE;
                if (aLong >= Short.MAX_VALUE)
